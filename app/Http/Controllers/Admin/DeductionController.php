...
class DeductionController extends Controller
{
    public function deductions()
    {
        ...
        return view('admin.deduction.deductiontable', compact('deductions'));
    }
    ...
    public function userDeductionsIndex(Request $request)
    {
        ...
        return view('admin.deduction.userdeduction', compact('users', 'deductions', 'userDeductions', 'departments'));
    }
