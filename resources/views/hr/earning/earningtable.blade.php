@extends('layouts.hrmaster') @section('title', 'Earnings') @section('content')
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form method="POST" action="{{ route('hr.createEarning') }}">
                    @csrf
...
<script>
    ...
    $('.edit-earning').on('click', function () {
        ...
        $('#editEarningForm').attr('action', '/hr/earning/edit/' +
            earningId);
    ...
    $('.delete-earning').on('click', function () {
        ...
        $('#deleteEarningForm').attr('action', '/hr/earning/delete/' + earningId);
