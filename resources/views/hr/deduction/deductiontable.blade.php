@extends('layouts.hrmaster') @section('title', 'Deductions') @section('content')
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form method="POST" action="{{ route('hr.createDeduction') }}">
                    @csrf
...
<script>
    ...
    $('.edit-deduction').on('click', function () {
        ...
        $('#editDeductionForm').attr('action', '/hr/deduction/edit/' +
            deductId);
    ...
    $('.delete-deduction').on('click', function () {
        ...
        $('#deleteDeductionForm').attr('action', '/hr/deduction/delete/' + deductId);
