    ...
    <div class="row justify-content-center">
        <div class="col-12 col-sm-10 col-md-10 col-lg-6 col-xl-5 text-center p-0 mt-3 mb-2">
            <div class="card2 px-0 pt-4 pb-0 mt-3 mb-3">
                ...
                <form id="msform" action="{{ route('hr.employeecreate') }}" method="POST">
                    @csrf
                    <!-- progressbar -->
                    <ul id="progressbar">
...
<script>
    $(document).ready(function () {
        ...
        $(".next").click(function (e) {
            ...
            $.ajax({
                url: step === 1 ? '/hr/employee/create/validate-step-1' : step === 2 ?
                    '/hr/employee/create/validate-step-2' : step === 3 ?
                    '/hr/employee/create/validate-step-3' : step === 4 ?
                    '/hr/employee/create/validate-step-4' :
                    '/hr/employee/create/validate-step-5',
                method: 'POST',
                data: formData,
