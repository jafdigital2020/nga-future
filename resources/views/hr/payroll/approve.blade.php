                ...
                <table class="table table-hover table-nowrap mb-0 datatable">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <form action="{{ route('hrpayroll.process', $app->id) }}" method="POST"
...
<script>
    $(document).on('click', '.preview-payroll', function (e) {
        ...
        $.ajax({
            url: `/hr/payroll/preview/${payrollId}`,
            method: 'GET',
...
<script>
    $('#payrollForm').on('submit', function (e) {
        ...
        $.ajax({
            url: `/hr/payroll/preview/process/${payrollId}`,
            method: 'POST',
            data: formData,
...
<script>
    ...
    document.getElementById('apply-bulk-action').addEventListener('click', function () {
        ...
        fetch('/hr/approve/processed/bulk-action', {
                method: 'POST',
                headers: {
