@extends('layouts.hrmaster') @section('title', 'Loan') @section('content')
                        ...
                        <tr>
                            <td>
                                <h2 class="table-avatar">
                                    <a href="{{ url('hr/employee/edit/'. $loan->user->id) }}" class="avatar"><img alt=""
                                            src="{{ asset('images/' . $loan->user->image) }}"></a>
                                    <a href="{{ url('hr/employee/edit/'. $loan->user->id) }}">{{ $loan->user->fName }}
                                        {{ $loan->user->lName }}
                                ...
                                <div class="dropdown action-label">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right">
                                        ...
                                        <form id="active-form-{{ $loan->id }}"
                                            action="{{ url('hr/loan/active/' . $loan->id) }}" method="POST"
                                        ...
                                        <form id="complete-form-{{ $loan->id }}"
                                            action="{{ url('hr/loan/complete/' . $loan->id) }}" method="POST"
                                            style="display:inline;">
                                            @csrf
                                        ...
                                        <form id="hold-form-{{ $loan->id }}"
                                            action="{{ url('hr/loan/hold/' . $loan->id) }}" method="POST"
                                            style="display:inline;">
                                            @csrf
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form method="POST" action="{{ route('hr.storeloan') }}">
                    @csrf
...
<script>
    ...
    $('.edit-loan').on('click', function () {
        ...
        $('#editLoanForm').attr('action', '/hr/loan/edit/' +
            loanId);
    ...
    $('.delete-loan').on('click', function () {
        ...
        $('#deleteLoanForm').attr('action', '/hr/loan/delete/' + loanId);
