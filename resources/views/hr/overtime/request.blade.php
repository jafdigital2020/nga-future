@extends('layouts.hrmaster') @section('title', 'Overtime')
                            ...
                            <td>
                                <h2 class="table-avatar">
                                    <a href="#" class="avatar">
                                        ...
                                        @endif</a>
                                    <a href="{{ url('hr/profile/') }}">{{ $ot->user->fName }}
                                        {{ $ot->user->lName }}
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form method="POST" action="{{ route('overtime.request.hr') }}">
                        @csrf
    ...
    <script>
        $(document).ready(function () {
            ...
            $('.edit-ot').on('click', function () {
                ...
                $('#editOtForm').attr('action', '/hr/overtime/edit/' +
                    otId);
                $('#edit_ot').modal('show');
            });
            ...
            $('.delete-ot').on('click', function () {
                ...
                $('#deleteOtForm').attr('action', '/hr/overtime/delete/' +
                    otId);
