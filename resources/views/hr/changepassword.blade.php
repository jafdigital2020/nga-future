@extends('layouts.hrmaster') @section('title', 'Change Password')
@section('content')
    ...
    <div class="page-header">
        <div class="row">
            <div class="col-sm-12">
                ...
                <ul class="breadcrumb">
                    <li class="breadcrumb-item"><a href="{{ route('main.hr') }}">Dashboard</a></li>
            ...
            <div class="row justify-content-center">
                <div class="col-md-6">
                    ...
                    <div class="card shadow">
                        ...
                        <div class="card-body">
                            <form action="{{ url('hr/profile/changepassword') }}" method="POST">
                                @csrf
                                <div class="mb-3">
                                ...
                                <a href="{{{ url('hr/profile') }}}" class="btn btn-success float-end"
                                    id="editBTN">Back</a>
                            </form>
                        </div>
                    </div>
