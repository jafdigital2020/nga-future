                                        ...
                                        <div class="dropdown dropdown-action">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-right">
                                                ...
                                                <a href="javascript:void(0);" class="dropdown-item" data-toggle="modal"
                                                    data-target="#delete_holiday" data-id="{{ $holiday->id }}">
                            ...
                            <div class="row g-4">
                                ...
                                <div class="col-md-6">
                                    <label for="holidayDay" class="form-label fw-bold">Holiday Day <span
                                            class="text-danger">*</span></label>
                                    <input type="text" id="holidayDay" name="holidayDay" class="form-control"
                                        readonly placeholder="Auto-filled day">
                                </div>
                            </div>
                    ...
                    <form id="editHolidayForm" action="{{ route('hr.updateHoliday') }}" method="POST">
                        ...
                        <div class="container p-4 border rounded shadow-sm bg-light">
                            ...
                            <div class="mb-4">
                                ...
                                <input type="date" id="editHolidayDate" name="holidayDate" class="form-control"
                                    required>
                            </div>
                            ...
                            <div class="mb-4">
                                ...
                                <input type="text" id="editHolidayDay" name="holidayDay" class="form-control"
                                    readonly>
                            </div>
