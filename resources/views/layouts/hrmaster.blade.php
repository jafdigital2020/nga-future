                    ...
                    <ul>
                        ...
                        <li class="submenu">
                            ...
                            <ul style="display: none">
                                <li>
                                    <a class="{{ Request::is('hr/dashboard') ? 'active':'' }}"
                                        href="{{ url('hr/dashboard') }}">Admin Dashboard</a>
                                </li>
                                <li>
                                    <a href="" class="">Employee Dashboard</a>
                                </li>
                            </ul>
                        </li>
                        <li class="submenu">
                            ...
                            <ul style="display: none">
                                <li>
                                    <a href="{{ url('hr/attendance') }}"
                                        class="{{ Request::is('hr/attendance') ? 'active':'' }}">Time in / Time Out</a>
                                </li>
                                <li>
                                    <a href="{{
                                                url('hr/attendance/empreport')
                                            }}" class="{{ Request::is('hr/attendance/empreport') ? 'active':'' }}">All
                        ...
                        <li class="submenu">
                            ...
                            <ul style="display: none">
                                <li>
                                    <a href="expense-reports.html">
                                        Expense Report
                                    </a>
                                </li>
                                <li>
                                    <a href="invoice-reports.html">
                                        Invoice Report
                                    </a>
                                </li>
                                <li>
                                    <a href="payments-reports.html">
                                        Payments Report
                                    </a>
                                </li>
                                <li>
                        ...
                        <li>
                            <a href="assets.html"><i class="la la-object-ungroup"></i>
                                <span>Assets</span></a>
                        </li>
                        <li class="submenu">
                            ...
                            <ul style="display: none">
                                ...
                                <li>
                                    <a href="offer_approvals.html">
                                        Offer Approvals
                                    </a>
                                </li>
                                <li>
                                    <a href="experiance-level.html">
                                        Experience Level
                                    </a>
                                </li>
                                <li>
                                ...
                                <li>
                                    <a href="schedule-timing.html">
                                        Schedule timing
                                    </a>
                                </li>
                                <li>
                                    <a href="apptitude-result.html">
                                        Aptitude Results
                                    </a>
                                </li>
                            </ul>
                        ...
                        <li>
                            <a href="activities.html"><i class="la la-bell"></i>
                                <span>Activities</span></a>
                        </li>
                        <li>
                            <a href="users.html"><i class="la la-user-plus"></i>
                                <span>Users</span></a>
                        </li>
                        <li>
                            <a href="settings.html"><i class="la la-cog"></i>
                        ...
                        <li class="submenu">
                            <a href="#"><i class="la la-object-group"></i>
                                <span> Forms </span>
                                <span class="menu-arrow"></span></a>
                            <ul style="display: none">
                                <li>
                        ...
                        <li>
                            <a href="javascript:void(0);"><i class="la la-info"></i>
                                <span>Change Log</span>
                                <span class="badge badge-primary ml-auto">v3.4</span></a>
                        </li>
                        <li class="submenu">
                            <a href="javascript:void(0);"><i class="la la-share-alt"></i>
