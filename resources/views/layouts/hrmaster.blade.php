                        ...
                        <ul>
                            ...
                            <li class="submenu">
                                ...
                                <ul style="display: none">
                                    <li>
                                        <a
                                            class="{{ Request::is('hr/dashboard') ? 'active':'' }}"
                                ...
                                <ul style="display: none">
                                    ...
                                    <li class="submenu">
                                        ...
                                        <ul style="display: none">
                                            ...
                                            <li>
                                                <a href="outgoing-call.html"
                                                    >Outgoing Call</a
                                                >
                                            </li>
                                            <li>
                                                <a href="incoming-call.html"
                                                    >Incoming Call</a
                                                >
                                            </li>
                                        </ul>
                            ...
                            <li class="submenu">
                                ...
                                <ul style="display: none">
                                    <li>
                                        <a
                                            href="{{ url('hr/attendance') }}"
                                            class="{{ Request::is('hr/attendance') ? 'active':'' }}"
                                            >Time in / Time Out</a
                                        >
                                    </li>
                                    <li>
                                        <a
                                            ...
                                            class="{{ Request::is('hr/attendance/empreport') ? 'active':'' }}"
                                            >All Employees Attendance</a
                                        >
                                    </li>
                                    <li>
                                        <a href="leaves.html"
                                            >Leaves (Admin)
                                            <span
                                                class="badge badge-pill bg-primary float-right"
                                                >1</span
                                            ></a
                                        >
                                    </li>
                            ...
                            <li class="submenu">
                                ...
                                <ul style="display: none">
                                    ...
                                    <li>
                                        <a href="budget-expenses.html"
                                            >Budget Expenses</a
                                        >
                                    </li>
                                    <li>
                                        <a href="budget-revenues.html"
                                            >Budget Revenues</a
                                        >
                                    </li>
                                </ul>
