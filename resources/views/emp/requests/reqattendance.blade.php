@extends('layouts.empmaster') @section('title', 'Request Attendance')
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <h2 class="table-avatar">
                                            ...
                                            @if ($req->attendance_approver)
                                                {{ $req->attendance_approver->fName }}
                                                {{ $req->attendance_approver->lName }}
                                            @else
                                                N/A
                                            @endif
                                        ...
                                        <div class="dropdown dropdown-action">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-right">
                                                <a class="dropdown-item edit-attendance" href="#"
                                                    data-id="{{ $req->id }}" data-date="{{ $req->date }}"
                                                    data-time_in="{{ $req->timeIn }}" data-time_out="{{ $req->timeOut }}"
                                                    data-time_total="{{ $req->timeTotal }}"
                                                    data-reason="{{ $req->reason }}" data-file="{{ $req->image_path }}"
                                                    data-status_code="{{ $req->status_code }}"><i
                                                        class="fa fa-pencil m-r-5"></i>
                                                    Edit</a>
                                                <a class="dropdown-item delete-att" href="#"
                                                    data-id="{{ $req->id }}">
            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form method="POST" action="{{ route('emp.storeCertificateAttendance') }}"
                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="break_hours"
                    ...
                    <div class="modal-body">
                        <form id="editAttForm" method="POST">
                            ...
                            <div class="form-group">
                                <label>Date</label>
                                <div class="cal-icon">
                                    <input class="form-control floating datetimepicker" type="text" name="datee"
                                        id="datee">
                                </div>
                            </div>
                            <div class="row">
                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        <label>Break Hours</label>
                                        <input type="text" class="form-control" id="break_hourse"
                                            placeholder="HH:MM:SS" pattern="[0-9]{2}:[0-9]{2}:[0-9]{2}">
                                    </div>
                                </div>
                                <div class="col-sm-12">
        ...
        <script>
            $(document).ready(function() {
                ...
                $(document).on('click', '.edit-attendance', function() {
                    ...
                    $('#editAttForm').attr('action', '/emp/request/attendance/update/' +
                        attId);
                    // Show the modal
                    $('#edit_att').modal('show');
                });
                ...
                $('.delete-att').on('click', function() {
                    ...
                    $('#deleteAttForm').attr('action', '/emp/request/attendance/delete/' + attId);
