                        ...
                        <div class="card flex-fill">
                            <div class="card-body">
                                    ...
                                    <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog"
                                        ...
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-footer">
                                                    <form id="clockOutForm" action="{{ url('manager/dashboard/clockout') }}"
                                ...
                                <div class="clock-in-info">
                                    ...
                                    <div class="clock-in-btn">
                                        <form id="overtimeInForm" action="{{ url('manager/dashboard/overtime') }}" method="POST" enctype="multipart/form-data">
                                            @csrf
                                    ...
                                    <div class="clock-in-btn">
                                        <form id="overtimeOutForm" action="{{ url('manager/dashboard/overtime') }}" method="POST" enctype="multipart/form-data">
                                            @csrf
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function() {
            ...
            function submitClockOutForm() {
                ...
                fetch("{{ url('manager/dashboard/clockout') }}", {
                        method: "POST",
                        body: formData,
                        headers: {
                            'X-CSRF-TOKEN': document.querySelector('meta[name="csrf-token"]').content
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            function fetchHolidays(callback) {
                $.ajax({
                    url: '/manager/dashboard/holidays/',
                    method: 'GET',
                    dataType: 'json',
