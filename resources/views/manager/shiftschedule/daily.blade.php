...
<div class="content container-fluid">
    ...
    <!-- Content Starts -->
    <!-- Search Filter -->
    <form action="{{ route('manager.dailyShift') }}" method="GET">
    ...
    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="{{ route('manager.dailyschedule') }}" method="POST">
                    @csrf
                    <div class="row">
...
<script>
    $(document).ready(function () {
        $('#edit_schedule').on('show.bs.modal', function (event) {
            ...
            $('#editScheduleForm').attr('action', '/manager/shift/daily/edit/' + shiftId);
