@extends('layouts.managermaster') @section('title', 'Geofencing')
<style>
    #map {
        height: 400px;
        width: 100%;
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form id="geofencingForm" action="{{ route('manager.createGeofence') }}" method="POST">
                        @csrf
                        <div class="row">
                            <div class="col-sm-4">
                                <div class="mb-3">
...
<script>
    $(document).ready(function () {
        ...
        $('.btn-edit').on('click', function () {
            ...
            $('#editGeofenceForm').attr('action', '/manager/geofencing/update/' + id);
            // Show the modal
        ...
        $('.btn-delete').on('click', function () {
            ...
            $('#deleteGeofenceForm').attr('action', '/manager/geofencing/delete/' + id);
