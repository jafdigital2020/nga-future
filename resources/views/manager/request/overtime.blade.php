        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form method="POST" action="{{ route('manager.overtime.request') }}" enctype="multipart/form-data">
                        @csrf
    ...
    <script>
        $(document).ready(function () {
            ...
            $('.edit-ot').on('click', function () {
                ...
                $('#editOtForm').attr('action', '/manager/overtime/edit/' +
                    otId);
                $('#edit_ot').modal('show');
            });
            ...
            $('.delete-ot').on('click', function () {
                ...
                $('#deleteOtForm').attr('action', '/manager/overtime/delete/' +
                    otId);
