        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form method="POST" action="{{ route('manager.storeCertificateAttendance') }}"
    ...
    <script>
        $(document).ready(function () {
            ...
            $(document).on('click', '.edit-attendance', function () {
                ...
                $('#editAttForm').attr('action', '/manager/request/attendance/update/' +
                    attId);
                // Show the modal
                $('#edit_att').modal('show');
            });
            ...
            $('.delete-att').on('click', function () {
                ...
                $('#deleteAttForm').attr('action', '/manager/request/attendance/delete/' + attId);
