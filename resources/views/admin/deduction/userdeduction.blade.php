@extends('layouts.master') @section('title', 'User Deduction')
...
<div class="content container-fluid">
        ...
        <div class="row">
            <div class="col">
                ...
                <ul class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="{{ url('admin/deduction/user') }}">User Deduction</a></li>
                </ul>
            </div>
    ...
    <!-- Content Starts -->
    <!-- Search Filter -->
    <form action="{{ route('admin.userDeductionsIndex') }}" method="GET">
                        ...
                        <tr>
                            <td>
                                <h2 class="table-avatar">
                                    <a href="{{ url('admin/employee/edit/'. $userDeduction->user->id) }}"
                                        class="avatar"><img alt=""
                                            src="{{ asset('images/' . $userDeduction->user->image) }}"></a>
                                    <a href="{{ url('admin/employee/edit/'. $userDeduction->user->id) }}">{{ $userDeduction->user->fName }}
    ...
    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="{{ route('admin.storeUserDeduction') }}" method="POST">
                    @csrf
...
<script>
    $(document).ready(function () {
        ...
        $('#department-select').change(function () {
            ...
            if (department) {
                $.ajax({
                    url: '{{ route("getEmployeesByDepartmentDeduction") }}',
                    method: 'GET',
                    data: {
    ...
    $(document).ready(function () {
        $('.delete-deduction').on('click', function () {
            ...
            if (confirm('Are you sure you want to delete this deduction?')) {
                $.ajax({
                    url: '/admin/deduction/user/delete/' + deductionId,
                    type: 'DELETE',
                    data: {
