...
@section('content')
    ...
    <div class="content container-fluid">
        ...
        <div class="page-header">
            <div class="row align-items-center">
                ...
                <div class="col-auto float-right ml-auto">
                    <a href="#" class="btn add-btn" data-toggle="modal" data-target="#reset_access_code">
                        Reset Access Code</a>
                </div>
            </div>
        </div>
        ...
        <div id="reset_access_code" class="modal fade" tabindex="-1" role="dialog" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    <form action="{{ route('admin.reset.accessCode', $user->id) }}" method="POST">
                        @csrf
                        <div class="modal-header">
                            <h5 class="modal-title">Reset Access Code</h5>
                        ...
                        <div class="modal-body">
                            <div class="form-group">
                                ...
                                <input type="text" id="new_access_code" name="new_access_code" class="form-control"
                                    required>
                            </div>
                        </div>
                        <div class="modal-footer">
                            <button type="submit" class="btn btn-primary">Reset Access Code</button>
            ...
            <div class="row user-tabs">
                <div class="col-lg-12 col-md-12 col-sm-12 line-tabs">
                    <ul class="nav nav-tabs nav-tabs-bottom">
                        ...
                        <li class="nav-item"><a href="#emp_salary" data-toggle="tab" class="nav-link">Employee Salary
                                Record
                                <small class="text-danger">(Admin/Manager Only)</small></a></li>
                    </ul>
                </div>
            ...
            <div id="emp_profile" class="pro-overview tab-pane fade show active">
                ...
                <div class="row">
                    <div class="col-md-4 d-flex">
                        <div class="card profile-box flex-fill">
                            <div class="card-body">
                                <h3 class="card-title">Government Mandates <a href="#" class="edit-icon"
                        ...
                        <div class="card profile-box flex-fill">
                            <div class="card-body">
                                <h3 class="card-title">Bank Information<a href="#" class="edit-icon"
                                        data-toggle="modal" data-target="#bank_info"><i class="fa fa-pencil"></i></a>
                                </h3>
                    ...
                    <div class="col-md-4 d-flex">
                        <div class="card profile-box flex-fill">
                            <div class="card-body">
                                <h3 class="card-title">Leave Credits<a href="#" class="edit-icon"
                                        data-toggle="modal" data-target="#leave_credits"><i class="fa fa-pencil"></i></a>
                                </h3>
                    ...
                    <div class="card-body">
                        ...
                        <div class="col-auto float-right ml-auto mb-3">
                            <a href="#" class="btn add-btn" data-toggle="modal"
                                data-target="#add_employee_record">
                                        ...
                                        <div class="card asset-card mb-3 shadow-sm">
                                            <div class="card-body">
                                                ...
                                                <p class="mb-1"><strong>Assignment Date:</strong>
                                                    {{ \Carbon\Carbon::parse($userAsset->assign_date)->format('F j, Y') }}
                                                </p>
                        ...
                        @if ($user->memos->isNotEmpty())
                            <div class="row">
                                @foreach ($user->memos as $memo)
                                        ...
                                        <div class="card memo-card mb-3 shadow-sm position-relative">
                                            <div class="card-body">
                                                ...
                                                <p>
                                                    @if ($memo->attached_file)
                                                        <a href="{{ asset('storage/' . $memo->attached_file) }}"
                                            ...
                                            <div class="position-absolute top-0 end-0 p-2">
                                                <a href="#" data-toggle="modal"
                                                    data-target="#editMemoModal-{{ $memo->id }}" class="text-danger">
                                    ...
                                    <!-- Edit Memo Modal -->
                                    <div class="modal fade" id="editMemoModal-{{ $memo->id }}" tabindex="-1"
                                        role="dialog" aria-labelledby="editMemoModalLabel-{{ $memo->id }}"
                                        aria-hidden="true">
                                        <div class="modal-dialog modal-dialog-centered" role="document">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h5 class="modal-title" id="editMemoModalLabel-{{ $memo->id }}">
                                                        Edit Memo</h5>
                                                    ...
                                                    <div class="modal-body">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="datetimepicker form-control"
                                                                name="date_issue" value="{{ $memo->date_issue }}">
                                                        </div>
                                                        <div class="form-group">
            ...
            <div class="tab-pane fade" id="emp_salary">
                <div class="card">
                    <div class="card-body">
                        <div class="col-auto float-right ml-auto">
                            <a href="#" class="btn add-btn" data-toggle="modal"
                                data-target="#add_employee_salary"><i class="fa fa-plus"></i> Add Employment Salary
                                Record</a>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control" name="proposalReason" id="proposalReason"></textarea>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <form action="{{ url('admin/employee/update/' . $user->id) }}" method="POST"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <div class="cal-icon">
                                                <input class="form-control datetimepicker" type="text"
                                                    name="dateHired" id="dateHired" value="{{ $user->dateHired }}">
                                            </div>
                                        </div>
                                    </div>
                                    <!-- Position -->
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label>
                                        <input type="checkbox" name="allow_multiple_login" id="allow_multiple_login"
                                            {{ $user->allow_multiple_login ? 'checked' : '' }}>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="mStatus" id="mStatus" required>
                                        <option>-</option>
                                        <option value="Single"
                                            {{ ($info->mStatus ?? '') == 'Single' ? 'selected' : '' }}>
                                            Single</option>
                                        <option value="Married"
                                            {{ ($info->mStatus ?? '') == 'Married' ? 'selected' : '' }}>
                                            Married</option>
