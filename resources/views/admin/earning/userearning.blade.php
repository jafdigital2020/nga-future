@extends('layouts.master') @section('title', 'User Earning')
...
<div class="content container-fluid">
        ...
        <div class="row">
            <div class="col">
                ...
                <ul class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="{{ url('admin/earning/user') }}">User Earning</a></li>
                </ul>
            </div>
    ...
    <!-- Content Starts -->
    <!-- Search Filter -->
    <form action="{{ route('admin.userEarningsIndex') }}" method="GET">
                        ...
                        <tr>
                            <td>
                                <h2 class="table-avatar">
                                    <a href="{{ url('admin/employee/edit/'. $userEarning->user->id) }}"
                                        class="avatar"><img alt=""
                                            src="{{ asset('images/' . $userEarning->user->image) }}"></a>
                                    <a href="{{ url('admin/employee/edit/'. $userEarning->user->id) }}">{{ $userEarning->user->fName }}
    ...
    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="{{ route('admin.storeUserEarning') }}" method="POST">
                    @csrf
...
<script>
    $(document).ready(function () {
        ...
        $('#department-select').change(function () {
            ...
            if (department) {
                $.ajax({
                    url: '{{ route("getEmployeesByDepartmentEarning") }}',
                    method: 'GET',
                    data: {
    ...
    $(document).ready(function () {
        $('.delete-earning').on('click', function () {
            ...
            if (confirm('Are you sure you want to delete this earning?')) {
                $.ajax({
                    url: '/admin/earning/user/delete/' + earningId,
                    type: 'DELETE',
                    data: {
