...
<div class="content container-fluid">
    ...
    <!-- Create Payroll -->
    <form action="{{ url('admin/payroll/edit/payslip/'. $payroll->id) }}" method="POST">
        @csrf
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-9">
                                        <input type="text" class="form-control" name="cut_off" id="cut_off"
                                            value="{{ $payroll->cut_off }}" readonly>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-9">
                                        <div class="cal-icon">
                                            <input class="form-control datetimepicker" id="start_date" name="start_date"
                                                placeholder="-- Select Date --" value="{{ $payroll->start_date }}"
                                                readonly />
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-lg-9">
                                        <div class="cal-icon">
                                            <input class="form-control datetimepicker" id="end_date" name="end_date"
                                                placeholder="-- Select Date --" value="{{ $payroll->end_date }}"
                                                readonly />
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-9">
                                        <input type="text" class="form-control" name="ename" id="ename"
                                            value="{{ $payroll->user->fName }} {{ $payroll->user->lName }}" readonly>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-9">
                                        <input type="text" class="form-control" name="position" id="position"
                                            value="{{ $payroll->user->position }}" readonly>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-9">
                                        <input type="text" class="form-control" name="department" id="department"
                                            value="{{ $payroll->user->department }}" readonly>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-9">
                                        <input type="text" class="form-control" name="totalHours" id="totalHours"
                                            value="{{ $payroll->totalHours }}" readonly>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-9">
                                <input type="text" class="form-control" name="grossMonthly" id="grossMonthly"
                                    value="{{ $payroll->user->mSalary  }}" readonly>
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-lg-9">
                                <input type="text" class="form-control" name="grossBasic" id="grossBasic"
                                    value="{{ $payroll->user->mSalary / 2  }}" readonly>
                            </div>
                        </div>
                        <div class="form-group row">
