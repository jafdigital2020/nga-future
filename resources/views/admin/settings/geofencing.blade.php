...
@section('content')
    <div class="content container-fluid">
                                ...
                                <tr>
                                    ...
                                    <td class="text-right">
                                        <a href="#" class="btn btn-success btn-sm btn-edit"
                                            data-id="{{ $geo->id }}" data-name="{{ $geo->fencing_name }}"
                                            data-address="{{ $geo->fencing_address }}"
                                            data-radius="{{ $geo->fencing_radius }}" data-latitude="{{ $geo->latitude }}"
                                            data-longitude="{{ $geo->longitude }}"
                                            data-expiration_date="{{ $geo->expiration_date }}"
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-4">
                                    <div class="mb-3">
                                        ...
                                        <input type="date" id="expirationDateInput" name="expiration_date"
                                            class="form-control">
                                    </div>
                                </div>
                                <div class="col-sm-4">
                                    <div class="mb-3">
                                        ...
                                        <select id="statusInput" name="status" class="form-select" required>
                                            ...
                                            <option value="Never Expired">Never Expired</option>
        ...
        <!-- Edit Geofence Modal -->
        <div class="modal fade" id="editGeofenceModal" tabindex="-1" role="dialog"
            aria-labelledby="editGeofenceModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="fencing_namee" id="editFencingName"
...
@section('scripts')
    ...
    <script>
        $(document).ready(function() {
            ...
            $('.btn-edit').on('click', function() {
                ...
                const expirationDate = $(this).data('expiration_date');
    ...
    <script>
        // Function to toggle expiration date input based on status selection
        document.getElementById('statusInput').addEventListener('change', function() {
            ...
            // If "Never Expired" is selected, disable the expiration date input
            if (this.value === 'Never Expired') {
                expirationDateInput.disabled = true;
                expirationDateInput.value = ''; // Clear the value when disabled
            } else {
                expirationDateInput.disabled = false; // Enable the expiration date input
            }
        });

        // Trigger the change event on page load to handle the default status
        document.getElementById('statusInput').dispatchEvent(new Event('change'));
    </script>
